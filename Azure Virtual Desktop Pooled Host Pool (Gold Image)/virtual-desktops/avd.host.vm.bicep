...
param azureUserProfileShare string
  ...
  properties: {
    ...
    settings: {
      ...
      properties: {
        ...
        'storageAccountName':dscStorageAccount
        'stContainer':'avdconfig'
      }
    }
  }
  dependsOn: [
...
output vmNames array = [for i in range(0, AVDnumberOfInstances) :{
  vmName:'${vmPrefixUpdated}-${i + currentInstances}'
  }]
